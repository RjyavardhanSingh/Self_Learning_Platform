...
export function WelcomePage() {
  return (
    <div className="min-h-dvh overflow-x-hidden bg-[#f7f7f5] text-zinc-950">
      ...
      <main>
        <section className="mx-auto max-w-7xl px-4 pb-16 pt-12 sm:px-8 sm:pb-20 sm:pt-20 lg:px-12 lg:pb-28 lg:pt-28">
          <div className="max-w-4xl">
            <div className="max-w-3xl">
              <Badge className="border-zinc-300 bg-white text-zinc-700">A calmer way to learn</Badge>
              <h1 className="mt-6 text-4xl font-semibold leading-[1.05] tracking-[-0.06em] text-zinc-950 sm:mt-7 sm:text-6xl lg:text-7xl">
                Turn what you study into what you <span className="text-zinc-400">remember.</span>
              </h1>
              <p className="mt-5 max-w-xl text-base leading-7 text-zinc-500 sm:mt-7 sm:text-lg sm:leading-8">
              ...
              <div className="mt-7 flex items-center gap-3 text-xs text-zinc-500 sm:mt-10">
        ...
        <section id="approach" className="mx-auto max-w-7xl px-4 py-14 sm:px-8 sm:py-20 lg:px-12">
      ...
      <footer className="border-t border-zinc-200 bg-white"><div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-6 text-xs text-zinc-400 sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-12"><span>Recall · Learn out loud</span><span>Focused practice for curious people.</span></div></footer>
    </div>
  )
}
